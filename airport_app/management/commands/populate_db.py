    ...
    def handle(self, *args, **options):
        ...
        for country_data in countries:
            ...
            for city_name in country_data["cities"]:
                ...
                airport = Airport.objects.create(name=f"{city_name} International", city=city)
        ...
        main_pilots = [Crew.objects.create(first_name=fake.first_name(), last_name=fake.last_name(), position=Crew.Position.MAIN_PILOT) for _ in range(3)]
        second_pilots = [Crew.objects.create(first_name=fake.first_name(), last_name=fake.last_name(), position=Crew.Position.SECOND_PILOT) for _ in range(3)]
        medics = [Crew.objects.create(first_name=fake.first_name(), last_name=fake.last_name(), position=Crew.Position.MEDIC) for _ in range(3)]
        stewardesses = [Crew.objects.create(first_name=fake.first_name(), last_name=fake.last_name(), position=Crew.Position.STEWARDESS) for _ in range(3)]
        crew_members = [Crew.objects.create(first_name=fake.first_name(), last_name=fake.last_name(), position=Crew.Position.CREW_MEMBER) for _ in range(3)]
        ...
        for i in range(9):
            ...
            departure_time = timezone.now() + timedelta(days=i * 2, hours=random.randint(0, 23))
